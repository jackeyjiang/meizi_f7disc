...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Graph widget demo",  ID_FRAMEWIN_0    ,   0,   0, 480, 272, FRAMEWIN_CF_MOVEABLE },
  { GRAPH_CreateIndirect,     0,                   ID_GRAPH_0       ,   5,   5, 425, 202 },
  { TEXT_CreateIndirect,      "Spacing X:",        0                ,  10, 212,  50,  20 },
  { TEXT_CreateIndirect,      "Spacing Y:",        0                ,  10, 232,  50,  20 },
  { SLIDER_CreateIndirect,    0,                   GUI_ID_SLIDER0   ,  60, 212,  60,  16 },
  { SLIDER_CreateIndirect,    0,                   GUI_ID_SLIDER1   ,  60, 232,  60,  16 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK0    , 130, 212,  50,   0 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK1    , 130, 232,  50,   0 },
  { TEXT_CreateIndirect,      "Border",            0                , 435,  37,  35,  15 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK2    , 435,  52,  35,   0 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK3    , 435,  72,  35,   0 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK4    , 435,  92,  35,   0 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK5    , 435, 112,  35,   0 },
  { TEXT_CreateIndirect,      "Effect",            0                , 435, 132,  35,  15 },
  { RADIO_CreateIndirect,     0,                   GUI_ID_RADIO0    , 430, 147,  35,   0, 0, 3 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK6    , 180, 212,  50,   0 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK7    , 180, 232,  50,   0 },
  { BUTTON_CreateIndirect,    "Full Screen",       GUI_ID_BUTTON0   , 400, 225,  65,  18 },
  { CHECKBOX_CreateIndirect,  0,                   GUI_ID_CHECK8    , 230, 232,  70,   0 },
};
...
static void _ForEach(WM_HWIN hWin, void * pData) {
  ...
  Id = WM_GetId(hWin);
  if ((Id == ID_GRAPH_0) || (Id == GUI_ID_BUTTON0) || (Id == GUI_ID_VSCROLL) || (Id == GUI_ID_HSCROLL)) {
    return;
  }
  if (FullScreenMode) {
    WM_HideWindow(hWin);
  ...
  case WM_NOTIFY_PARENT:
    ...
    case WM_NOTIFICATION_VALUE_CHANGED:
      ...
      case GUI_ID_CHECK8:
        ...
        // Toggle alignment
        //
        WM_GetDialogItem(hDlg, ID_GRAPH_0);
        for (i = 0; i < GUI_COUNTOF(_aColor); i++) {
...
*/
WM_HWIN CreateTemperatureWavePage(void);
WM_HWIN CreateTemperatureWavePage(void) {
  WM_HWIN hWin;
