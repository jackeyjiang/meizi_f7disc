...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate1[] = {
    ...
    //{ LISTWHEEL_CreateIndirect, "Listview",          GUI_ID_SLIDER0,          10,10,  460,252,0,0},
};
...
*       MainTask
*/
void _cbWheelCallback(WM_MESSAGE * pMsg)  {
...
//        break;
    case WM_INIT_DIALOG:
        hItem = pMsg->hWin;
          ...
          // Create buttons
          //    
          hButton0 = BUTTON_CreateEx(10, 35, 50, 25, hItem, WM_CF_SHOW, 0, GUI_ID_BUTTON0);
          BUTTON_SetText(hButton0, "Cancel");
          WM_SetCallback(hButton0, _cbButton);
          WM_DisableMemdev(hButton0);
          WM_SetHasTrans(hButton0);

          hButton1 = BUTTON_CreateEx(180, 35, 50, 25, hItem, WM_CF_SHOW, 0, GUI_ID_BUTTON1);
          ...
          // Create a non transparent background window for the LISTWHEELS
          //
          hBkWheel = WM_CreateWindowAsChild(15, 170, 210, 100, WM_HBKWIN, WM_CF_SHOW, _cbBkWheel, 0);
          //
          // Create the LISTWHEELS
          //
          _CreateListWheel(  0, 0,  40, 100, GUI_ID_LISTWHEEL0, _apDay,   GUI_COUNTOF(_apDay),   GUI_TA_VCENTER | GUI_TA_HCENTER, hBkWheel, &_aWheel[0]);
          _CreateListWheel( 40, 0, 110, 100, GUI_ID_LISTWHEEL1, _apMonth, GUI_COUNTOF(_apMonth), GUI_TA_VCENTER | GUI_TA_RIGHT,   hBkWheel, &_aWheel[1]);
          _CreateListWheel(150, 0,  60, 100, GUI_ID_LISTWHEEL2, _apYear,  GUI_COUNTOF(_apYear),  GUI_TA_VCENTER | GUI_TA_HCENTER, hBkWheel, &_aWheel[2]);
...
/*********************************************************************
*
*       CreateTemperatureWavePage
*/
WM_HWIN CreateListWheelPage(void);
WM_HWIN CreateListWheelPage(void) {
  WM_HWIN hWin;
  hWin = GUI_CreateDialogBox(_aDialogCreate1, GUI_COUNTOF(_aDialogCreate1), _cbWheelCallback, WM_HBKWIN, 0, 0);
  return hWin;
}
